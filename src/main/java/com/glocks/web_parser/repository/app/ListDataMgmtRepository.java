...
@Repository
public interface ListDataMgmtRepository extends JpaRepository<ListDataMgmt, Long> {



    @Query("select u from ListDataMgmt u where u.transactionId= :transactionId")
    ListDataMgmt findAllByTransactionId (@Param("transactionId") String transactionId);
